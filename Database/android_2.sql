...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 31, 2023 lúc 08:27 PM
...
CREATE TABLE `sanpham` (
  ...
  `MaMau` int(10) UNSIGNED DEFAULT NULL,
  `MaLoai` int(10) UNSIGNED NOT NULL,
  `MaSize` int(10) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1120, 'Áo sơ mi tay dài sợi Modal Tối Giản', 6, 'https://cdn2.yame.vn/pimg/so-mi-nam-no-style-td-km18-0018246/8c0fe088-005b-0200-3f26-001a20115d2c.jpg?w=540&h=756&c=true&ntf=false', 'Được làm từ 12% modal và 88% superfine, ít nhăn và dễ ủi, nhanh khô và thoáng mát', 255000, 2, 3, 1),
(1121, 'Áo sơ mi tay dài sợi Cotton TSONS 31', 7, 'https://cdn2.yame.vn/pimg/so-mi-tay-dai-on-gian-y-nguyen-ban-ver46-0021352/9164c555-da49-7600-5b3d-001a298718d1.jpg?w=540&h=756&c=true&ntf=false', '72% Cotton 28% Polyester\r\nThoáng mát\r\nThấm hút mồ hôi\r\nHút ẩm tốt\r\nHạ nhiệt và làm mát cơ thể\r\nĐộ bền tương đối cao\r\nMềm mịn\r\n+ Vạt áo dạng vạt bầu\r\n+ Túi áo trước ngực tiện lợi hình thêu tinh tế\r\n+ Lá cổ cài khuy giúp định hình cổ áo', 257000, 2, 3, 1),
(1122, 'Áo Sơ Mi Tay Dài Sợi Poly', 4, 'https://cdn2.yame.vn/pimg/so-mi-tay-dai-on-gian-y-nguyen-ban-ver26-0020866/28ddd072-cc46-1100-0b47-001a1db57b85.jpg?w=540&h=756&c=true&ntf=false', 'Sơ Mi Tay Dài Đơn Giản Y Nguyên Bản Ver26\r\nHọa tiết may logo kim loại\r\nForm dáng rộng rãi thoải mái và thời trang', 297000, 2, 3, 1),
(1123, 'Áo Sơ Mi Tay Ngắn Cuban Valknut', 7, 'https://cdn2.yame.vn/pimg/so-mi-co-danton-than-co-ai-valknut-ver3-0021525/893222ae-ddc3-cf00-bc57-0019aa36f94a.jpg?w=540&h=756', 'Được làm từ 100% Polyester\r\nCo giãn tốt\r\nVải nhẹ\r\nMềm mịn\r\nThấm hút\r\nNhanh khô\r\nHọa tiết in chuyển nhiệt\r\n', 257000, 2, 3, 1),
(1124, 'Áo Sơ Mi Tay Ngắn Sợ Cotton', 2, 'https://cdn2.yame.vn/pimg/so-mi-tay-ngan-on-gian-y-nguyen-ban-ver16-0021045/c8a4a788-2125-7000-2113-001a2d78c0e0.jpg?w=540&h=756&c=true&ntf=false', 'Được làm từ 65% Cotton 35% Polyester, kiếu basic đơn giản', 197000, 2, 3, 1),
...
(1140, 'Quần Dài Vải Nguyên Bản Ver3', 5, 'https://cdn2.yame.vn/pimg/quan-dai-sweatpants-on-gian-y-original-ver1-0020311/7258a8c4-d9fa-0f00-7288-001880661566.jpg?w=540&h=756', 'Được làm từ 100% polyCo giãnVải nhẹMềm mịnĐộ bềnDễ dàng giặt ủiHọa tiết in dẻoHai túi trước có dây kéoDây Rút Giấu Cạp TrongQuần bo vào mắt cá chân, cực kì hiệu quả trong việc che khuyết điểm', 285000, 2, 1, 1),
(1142, 'Quần Tây Tối Giản HG17', 5, 'https://cdn2.yame.vn/pimg/quan-tay-y2010-hg17-0019806/c19a08c6-a057-0400-7540-001a19f7abf6.jpg?w=540&h=756', 'Được làm từ 82% polyester 14% rayon 4% spandexMềm mạiThoáng khíThân thiện với mối trườngHút ẩm tốt', 325000, 2, 1, 1),
(1143, 'Quần Tây TSONS 08', 5, 'https://salt.tikicdn.com/cache/w1200/ts/product/76/2c/71/b3feea0a4548e0aaa400f99b8584113a.jpg', 'Được làm từ 82% Polyester 14% Rayon 4% Spandex\r\nCo dãn tốt\r\nKháng khuẩn\r\nMềm mịn\r\nÍt nhăn\r\nĐộ bền màu tương đối tốt lắm', 277000, 2, 1, 1),
...
(1152, 'tee', 10, 'https://salt.tikicdn.com/cache/w1200/ts/product/76/2c/71/b3feea0a4548e0aaa400f99b8584113a.jpg', 'lalalalaal', 300000, NULL, 4, NULL),
(1153, 'tee23232', 5, 'https://cdn2.yame.vn/pimg/quan-dai-loose-pants-ngan-ha-space-ver1-0020629/eccdfd1d-0de0-6600-aa90-0018cd6ce23d.jpg?w=540&h=756', 'hayhay', 700000, NULL, 1, NULL);
...
INSERT INTO `taikhoan` (`TenTK`, `MK`, `TenKH`, `SDT`, `DiaChi`, `Email`, `Role`) VALUES
('admin', '123456', 'admin', NULL, NULL, NULL, 1),
('hoaidinh', '123456', 'Lê Hoài Dinh', '0708138564', 'Lê Trọng Tấn - Tây Thạnh - Tân Phú', 'lehoaidinh@gmail.com', 0),
('phibang', '123456', 'Trần Phi Bằng', '09037586434', 'Lê Trọng Tấn - Tây Thạnh - Tân Phú', 'tranphibang@gmail.com', 0),
('tantruong', '123456', 'Lê Bùi Tấn Trưởng', '0328467924', 'Lưu Chí Hiếu - Tây Thạnh - Tân ', 'lebuitantruong@gmail.com', 0);
...
--
ALTER TABLE `chitietdonhang`
  ADD CONSTRAINT `chitietdonhang_ibfk_1` FOREIGN KEY (`iddon`) REFERENCES `donhang` (`id`),
  ADD CONSTRAINT `fk_ctdh_sp` FOREIGN KEY (`idsp`) REFERENCES `sanpham` (`MaSp`);

--
-- Các ràng buộc cho bảng `donhang`
--
ALTER TABLE `donhang`
  ADD CONSTRAINT `donhang_ibfk_1` FOREIGN KEY (`iduser`) REFERENCES `taikhoan` (`TenTK`);
